export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenFDS Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "OpenFDS CLI binary is missing. Try reinstalling the desktop app.",
