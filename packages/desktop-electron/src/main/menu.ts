...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "OpenFDS Documentation", click: () => shell.openExternal("https://github.com/anomalyco/openfds") },
        ...
        { type: "separator" },
        {
          ...
          click: () =>
            shell.openExternal("https://github.com/anomalyco/openfds/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/anomalyco/openfds/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
