  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all OpenFDS sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific OpenFDS session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new OpenFDS session for interacting with AI assistants and managing conversations.",
